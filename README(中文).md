...
![](https://github.com/YUHESEN-Robot/DT-mid-ros2/blob/main/images/CAN_Connection.png?raw=true)
...
![](https://github.com/YUHESEN-Robot/DT-mid-ros2/blob/main/images/terminal_state.png?raw=true)  
...
![](https://github.com/YUHESEN-Robot/DT-mid-ros2/blob/main/images/candump_print.png?raw=true)

## 5.ROS2驱动包运行
####      5.1、文件结构：
      
![](https://github.com/YUHESEN-Robot/DT-mid-ros2/blob/main/images/doc_tree.png?raw=true)
...
![](https://github.com/YUHESEN-Robot/DT-mid-ros2/blob/main/images/source.png?raw=true)

####      5.4、ROS2驱动启动：
            在你刚才输入了临时环境变量的终端中执行指令：
            ros2 launch yhs_can_control yhs_can_control.launch.py
![](https://github.com/YUHESEN-Robot/DT-mid-ros2/blob/main/images/launch.png?raw=true)
            
####      5.5、终端打印出的运行成功信息：

![](https://github.com/YUHESEN-Robot/DT-mid-ros2/blob/main/images/node_print.png?raw=true)  
...
![](https://github.com/YUHESEN-Robot/DT-mid-ros2/blob/main/images/rqt_tool.png?raw=true)